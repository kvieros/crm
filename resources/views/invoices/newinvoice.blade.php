                    ...
                    <form class="form-horizontal" id="addinvoice" method="post" action="addinvoice">
                        {{ csrf_field() }}
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" value="{{ $item->id }}" class="form-control" name="id" placeholder="">
                                </div>
                            </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="number" value="{{ $item->price }}" class="form-control" name="price" placeholder="" disabled>
                            </div>
                        </div>
                        <div class="form-group">
